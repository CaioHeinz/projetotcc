...
function cadastrar() {
  if (validNome && validUsuario && validSenha && validConfirmSenha) {
    ...
    let tipoCadastro = document.getElementById("tipoCadastro").value;
    ...
    if (tipoCadastro === "Prestador de Serviço") {
      ...
      usuarioCadastro.emailCad = emailEmpresa;
      usuarioCadastro.nomeEmpresaCad = nomeEmpresa;
      usuarioCadastro.telefoneCad = telefoneEmpresa;
    }

    listaUser.push(usuarioCadastro);
